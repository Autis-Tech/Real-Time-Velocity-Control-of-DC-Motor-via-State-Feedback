%% Scripte name: State_Feedback_Control_Implementation.m
...
% Reference scaling gain (recompensation gain)
kr = -1 / (C * inv(A - B*K) * B);  
...
for k = 1:length(t)
    ...
    u_State_Feedback_Volt = -K * [estimatedCurrentA; filtredVelocityRPM]  + kr * referenceVelocityRPM; 
